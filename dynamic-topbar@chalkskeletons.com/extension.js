...
class Extension {
    ...
    disable() {
        ...
        Main.panel.remove_style_class_name('transparent-top-bar--transparent');
                        Main.panel.remove_style_class_name('transparent-top-bar--invert');
    }
    ...
    _updateTransparent() {
            ...
            let isInverted = settings.get_boolean('invert-panel');
            
            
      if (isInverted) {
                Main.panel.add_style_class_name('transparent-top-bar--invert');
    }
