...
convert -scale 10% -brightness-contrast -20x-15 -gaussian-blur 0x8 -resize 1000% "$BG" ~/.local/share/backgrounds/blurred_fast.jpg
...
convert -resize "$SCREEN" -crop "$WIDTH"x33+0+0  -brightness-contrast 5x4 -gaussian-blur 0x330 ~/.local/share/backgrounds/blurred_test.jpg ~/.local/share/backgrounds/blurred_panel.jpg
